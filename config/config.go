...
func setupLogging(debug bool) {
	// A dependency logging through the standard logger would land on stderr, and gocui draws by
	// absolute position, so one stray line scrolls the screen and every later frame renders a row off.
