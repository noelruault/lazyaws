...
- s9-footer-labels 89519e3 — the options bar is built per focused view in the redesign's vocabulary, ordered by frequency instead of alphabetically by keycap, with every rebindable label read from the keymap and an 86-cell worst case under a tested 90-cell budget
